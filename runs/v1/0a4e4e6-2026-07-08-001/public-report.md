...
**Git SHA**: `0a4e4e6` | **Assembled**: 2026-07-08T13:24:49.061Z

**Total cases**: 45 | **Passed**: 36 | **Failed**: 9
...
| pattern-plan-release-checklist | openai/gpt-5.5 | ✅ pass | yes | required execution case passed; dimensions: executionCompleteness, rationaleQuality |
...
| weft-review-clean-approval | anthropic/claude-sonnet-4.5 | ⚠️ partial | yes | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |
