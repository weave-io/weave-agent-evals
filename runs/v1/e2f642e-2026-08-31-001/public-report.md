...
**Git SHA**: `e2f642e` | **Assembled**: 2026-08-31T17:40:30.491Z

**Total cases**: 75 | **Passed**: 33 | **Failed**: 42
...
| Case ID | Model | Score | Passed | Explanation |
|---------|-------|-------|--------|-------------|
| pattern-plan-release-checklist | anthropic/claude-opus-4.5 | ⚠️ partial | no | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |
