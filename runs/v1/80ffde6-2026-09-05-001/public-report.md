...
**Git SHA**: `80ffde6` | **Assembled**: 2026-09-05T21:00:29.642Z

**Total cases**: 296 | **Passed**: 257 | **Failed**: 39
...
| loom-route-weft-boundary-downstream-review | anthropic/claude-opus-4.5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-pattern-boundary-small-fix | openai/gpt-5.5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-shuttle-boundary-plan-first | openai/gpt-5.5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-spindle-boundary-internal-exploration | openai/gpt-5.5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-thread-boundary-prehop-then-implement | openai/gpt-5.5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-weft-boundary-downstream-review | openai/gpt-5.5 | ✅ pass | yes | required routing case passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-pattern-boundary-small-fix | anthropic/claude-opus-5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-thread-boundary-prehop-then-implement | anthropic/claude-opus-5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-backend-api | qwen/qwen3.8-max | ✅ pass | yes | required routing case passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-shuttle-implement-utility | qwen/qwen3.8-max | ✅ pass | yes | required routing case passed; dimensions: routingCorrectness, rationaleQuality |
| loom-route-spindle-boundary-internal-exploration | qwen/qwen3.8-max | ❌ fail | no | required routing case failed; dimensions: routingCorrectness, rationaleQuality |
| loom-route-spindle-research-oauth-pkce | qwen/qwen3.8-max | ❌ fail | no |  |
...
| loom-route-weft-boundary-downstream-review | qwen/qwen3.8-max | ✅ pass | yes | required routing case passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-ambiguous-direct-shuttle | deepseek/deepseek-v4-flash-0731 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-pattern-boundary-small-fix | deepseek/deepseek-v4-flash-0731 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-spindle-research-oauth-pkce | deepseek/deepseek-v4-flash-0731 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
| loom-route-thread-boundary-prehop-then-implement | deepseek/deepseek-v4-flash-0731 | ❌ fail | no | required routing case failed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-warp-boundary-downstream-audit | deepseek/deepseek-v4-flash-0731 | ❌ fail | no | required routing case failed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-ambiguous-direct-shuttle | openai/gpt-6-astra | ❌ fail | no | required routing case failed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-spindle-research-oauth-pkce | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
| loom-route-thread-boundary-prehop-then-implement | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-warp-boundary-downstream-audit | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
| loom-route-warp-security-audit-auth-flow | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| loom-route-weft-review-checkout-pr | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness, rationaleQuality |
...
| tapestry-delegate-to-shuttle | openai/gpt-5.5 | ⚠️ partial | yes | required delegation case partially passed; dimensions: delegationCorrectness, rationaleQuality |
...
| tapestry-delegate-to-shuttle | openai/gpt-5.6-sol | ⚠️ partial | yes | required delegation case partially passed; dimensions: delegationCorrectness, rationaleQuality |
...
| tapestry-delegate-to-shuttle | openai/gpt-6-astra | ⚠️ partial | yes | required delegation case partially passed; dimensions: delegationCorrectness, rationaleQuality |
| tapestry-execute-plan-step | openai/gpt-6-astra | ⚠️ partial | yes | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |
...
| shuttle-execution-report-tests-and-assumptions | deepseek/deepseek-v4-flash-0731 | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |
...
| shuttle-execution-report-tests-and-assumptions | openai/gpt-6-astra | ⚠️ partial | no | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |
...
| spindle-tools-citations-facts-confidence | deepseek/deepseek-v4-flash-0731 | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |
...
| spindle-tools-citations-facts-confidence | openai/gpt-6-astra | ⚠️ partial | yes | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |
| spindle-tools-source-boundary-network-claims | openai/gpt-6-astra | ⚠️ partial | yes | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |

### Suite: pattern-planning — 🔴 red

**Total**: 16 | **Passed**: 6 | **Failed**: 10
...
| pattern-plan-settings-refactor | deepseek/deepseek-v4-flash-0731 | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |
| pattern-plan-release-checklist | openai/gpt-6-astra | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |
...
| weft-review-clean-approval | openai/gpt-6-astra | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |
| weft-review-reject-blocker-citation | openai/gpt-6-astra | ⚠️ partial | yes | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |

### Suite: warp-security — 🔴 red

**Total**: 16 | **Passed**: 10 | **Failed**: 6
...
| warp-security-block-evidence-findings | openai/gpt-5.6-sol | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |
...
| warp-security-block-evidence-findings | deepseek/deepseek-v4-flash-0731 | ⚠️ partial | no | required execution case partially passed; dimensions: executionCompleteness, rationaleQuality |
...
| warp-security-block-evidence-findings | openai/gpt-6-astra | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |
| warp-security-fast-exit-approve | openai/gpt-6-astra | ❌ fail | no | required execution case failed; dimensions: executionCompleteness, rationaleQuality |

### Suite: tapestry-category-routing — 🔴 red

**Total**: 80 | **Passed**: 77 | **Failed**: 3
...
| tcr-08-misleading-prose | anthropic/claude-sonnet-4.5 | ❌ fail | no | required routing case failed; dimensions: routingCorrectness |
...
| tcr-10-disabled-category | anthropic/claude-sonnet-4.5 | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
...
| tcr-06-overlap | anthropic/claude-opus-5 | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
...
| tcr-05-cross-category | qwen/qwen3.8-max | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
| tcr-06-overlap | qwen/qwen3.8-max | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
| tcr-07-explicit-hint | qwen/qwen3.8-max | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
| tcr-08-misleading-prose | qwen/qwen3.8-max | ❌ fail | no | required routing case failed; dimensions: routingCorrectness |
...
| tcr-06-overlap | deepseek/deepseek-v4-flash-0731 | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
...
| tcr-01-exact-match | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
| tcr-02-multiple-files | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
| tcr-03-windows-paths | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
| tcr-04-no-match | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
| tcr-05-cross-category | openai/gpt-6-astra | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
| tcr-06-overlap | openai/gpt-6-astra | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
| tcr-07-explicit-hint | openai/gpt-6-astra | ⚠️ partial | yes | optional routing case partially passed; dimensions: routingCorrectness |
| tcr-08-misleading-prose | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
| tcr-09-similar-names | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
| tcr-10-disabled-category | openai/gpt-6-astra | ⚠️ partial | yes | required routing case partially passed; dimensions: routingCorrectness |
